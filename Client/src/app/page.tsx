...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* ─── Hero Section ─── */}
      <section
        className="gradient-hero relative overflow-hidden min-h-[480px]"
      >
        {/* Decorative shapes */}
        <div
          className="absolute -top-16 -right-16 w-[300px] h-[300px] bg-white/5 rounded-full pointer-events-none"
        />
        <div
          style={{
            position: "absolute",
        ...
        <button
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/15 border-none text-white w-10 h-10 rounded-full text-[1.1rem] cursor-pointer backdrop-blur-sm z-10"
        >
          ‹
        </button>
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/15 border-none text-white w-10 h-10 rounded-full text-[1.1rem] cursor-pointer backdrop-blur-sm z-10"
        >
          ›
        </button>
      ...
      <section
        id="how-it-works"
        style={{ padding: "4rem 1.5rem", background: "#fff" }}
      >
              ...
              <div key={step.step} style={{ textAlign: "center" }}>
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, #e1effe, #c7d9fd)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: "2rem",
      ...
      <section
        style={{ padding: "4rem 1.5rem", background: "#f8fafc" }}
      >
        <div
          style={{
            maxWidth: 1200,
